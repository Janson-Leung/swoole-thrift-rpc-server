...
class HelloWorldClient implements \Services\HelloWorld\HelloWorldIf {
  ...
  {
    $args = new \Services\HelloWorld\HelloWorld_sayHello_args();
    $args->name = $name;
  ...
  public function recv_sayHello()
  {
    ...
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\Services\HelloWorld\HelloWorld_sayHello_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
